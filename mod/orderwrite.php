...
if($_REQUEST['action']=="orderwrite")
{
       ...
       $sql="INSERT INTO ads (userid, title, region, phone, firstid,  term, workload, adtext)
				VALUES ($userid, '$title', '$region','$phone','$catid', '$term', '$workload', '$adtext');";
...
if($_REQUEST['action']=="orderred")
{
    ...
    if(isset($_REQUEST['orderid']))
    {
       ...
       $userid=mysql_escape_string($_SESSION['userid']); 
        $sql="UPDATE ads SET  title='$title',region='$region',phone='$phone',firstid='$firstid',term='$term',
